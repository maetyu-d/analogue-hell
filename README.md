...
A counterpoint to my [Digitalis suite](https://github.com/maetyu-d/digitalis/), Analogue Hell is a suite of 10 plugins that explore analogue breakdown, malfunction, and haunted calibration aesthetics. To put another way, if they were a hotel, they'd be the kind that Gordon Ramsay visits and, for reasons unknown, insists on baring his bum while critiquing the bathroom facilities... Created using JUCE.
